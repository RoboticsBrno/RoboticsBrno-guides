...
%\usepackage[yyyymmdd]{datetime} % Slouží pro vkládání data
...
\chapter{Přílohy}  \addcontentsline{toc}{chapter}{Přílohy}
 ...
 \label{rejstrik}
	...
	\input novinky.tex
	\input rozcestnik.tex

\end{document}

%todo seznam úkolů
% doplnit do rejstříku velká počáteční písmena a seřadit ho podle české abecedy 
% vytvořit proklikávání v  rejstříku 
% software pro videonávody?
% udělat podrobný návod pro VSCode do gitu = verzování do VSCode 
% doplnit sekci section Příkazy C++ pro čipy 
% sepsat sekci Základní doporu£ení pro programování
% do kapitoly Onshape doplnit fotky s popisy + \index , taky do osciloskopu
...
% součástky: tlačítko včetně zapojení, barevný senzor, měření napětí  
...
% onshape - výkresy dodělat + práce s laserem 
% vscode - dodělat 
% osciloskop - dodělat 
% zdrojové kódy pro programování součástek 
% drawio
% doplnit step-down 
% doplnit checklist 
% PCBDraw https://github.com/yaqwsx/PcbDraw
% přednášky pro VUT  - https://moodle.fel.cvut.cz/course/view.php?id=2000
