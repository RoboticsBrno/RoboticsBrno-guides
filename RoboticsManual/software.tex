...
\begin{itemize}
 ...
 Video s krátkým představením Lorris: \url{http://www.youtube.com/watch?v=LkmFn40BbX8}.
  ...
  \hyperref[prog:lorris]{Příklad} posílání dat pro Lorris. \label{lorris}
...
\item V Linuxu se celkově mnohem víc (a účiněji) používá příkazová řádka neboli program  {\tt terminál}. \index{termiál} Spouští se klávesovou zkratkou {\tt Ctrl+Alt+T} nebo v Lubuntu spustíte správce souborů (2. ikona dole vlevo), přepnete se do požadovaného adresáře a stisknete {\tt F4}. 
