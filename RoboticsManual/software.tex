...
\subsection{Atom} \index{Atom}

\textbf{Atom} je výkonný textový editor, hodně podobný programu Visual Studio Code. %todo doplnit

\subsection{Arduino IDE} \index{Arduino IDE}

\textbf{Arduino IDE} je jednoduchý textový editor určený pro začátky v programování řídících desek klonu Arduino. %todo doplnit
