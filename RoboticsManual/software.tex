 ...
 \textbf{Cpp4robots} je rozšíření do vývojového IDE\index{IDE} \textit{Microsoft Visual Studio} (to není \textit{ \hyperref[vscode]{Visual Studio Code}}) určené pro programování robotů řízených \uv{Lego kostkou} EV3 v jazyce C++.
 ...
 Kostka EV3 lze programovat přes USB kabel nebo Bluetooth. 
 Aby robot fungoval autonomně i bez kabelu, musí být v kostce Micro SD karta, doporučená velikost je 8~--~32~GB. 
 
 Oficiální dokumentace na \href{http://www.cpp4robots.cz/}{www.cpp4robots.cz}.
...
\href{http://tasssadar.github.io/Lorris/cz/index.html}{Domovská stránka} Lorris.
...
\href{www.github.com}{\bf Github} je v současnosti jeden z nejpoužívanějších webů pro tvorbu a~správu repozitářů. Další populární web je \href{www.bitbucket.org}{\bf Bitbucket}.
...
\subsection{Atom} \index{Atom} \label{atom}
 ...
 \href{https://atom.io/}{Atom} je výkonný textový editor (IDE\index{IDE}), hodně podobný programu \hyperref[vscode]{Visual Studio Code}. 
