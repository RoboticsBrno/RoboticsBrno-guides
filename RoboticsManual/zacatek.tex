...
% řešení 1: https://en.wikibooks.org/wiki/LaTeX/Labels_and_Cross-referencing#Anchor_manual_positioning
% řešení 2: https://tex.stackexchange.com/questions/234071/highlight-hyperlinks-with-missing-destinations/241164 
\color{red} autonomního \color{black}TODO robota, nejčastěji pro nějakou soutěž\footnote{Robotiáda v~Brně: \url{http://www.robotiada.cz/}, Robotický den v Praze \url{http://robotickyden.cz/} }. 
...
\item  vývojovou desku ALKS\footnote{\url{https://github.com/RoboticsBrno/ArduinoLearningKitStarter} \hfil \break {\color{red} NUTNÁ AKTUALIZACE} 
...
%% formátování textu uvnitř \index{text}: https://en.wikibooks.org/wiki/LaTeX/Indexing#Sophisticated_indexing
{\it Visual Studio Code} \index{Visual~Studio~Code} (zkráceně VS Code) je něco jako textový editor, speciálně navržený pro programátory čehokoliv.
...
\index{PlatformIO} PlatformIO je ten software, který umožní program v~C++ přeložit tak, aby ho čip pochopil a~taky ho do čipu umí nahrát. 
...
Začínáme v~okně 
%% nevím jak vyřešit \dest[ref:explorer] - jde o odkaz do textu?
% \dest[ref:explorer] {\it Explorer}, \ii explorer 
{\it Explorer} \index{explorer} kde je umístěna adresářová struktura projektu\footnote{Pokud toto okno není vidět, zobrazíte ho v~menu {\it View} položka {\it Explorer} }.
